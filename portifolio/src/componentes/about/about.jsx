    ...
    return (
      ...
      {/* Conteúdo */}
             <div className="content d-flex flex-row">
                <div id="c1" className="tab-content w-75 text-end">
                 <img className='rounded-circle animate-float img' src={foto} alt="" />
                <p className="about-text text-white pt-5 px-4 align-content-center fs-4">
             ...
             <div id="c2" className="tab-content w-75 text-end">
                    <img className=' rounded-circle animate-float img' src={foto2} alt="" />
                    <p className='about-text text-white pt-5 px-4 align-content-center fs-4'>
                    ...
                    <div id="c3" className="tab-content w-75">
                        <img className='rounded-circle animate-float img' src={fotoesportes} alt="" />
                    </div>
                </div>
            </div>
    </section>
