...
export default function maincontainer() {
    return (
        <section className="maincontainer pt-5 px-5 d-flex flex-row" id='maincontainer'>
            <div className='d-flex flex-column justify-content-start align-items-start pt-4 mt-3 ms-5 ps-5'>
                ...
                <p className='subtitle-main text-secondary fs-6 w-75'>We provide the best home design, construction and maintenance services for you and your family.</p>
                ...
                <div className="numbers d-flex gap-5 pt-lg-4 me-lg-5">
                    <div className='number '>
                        <h3 className='number fs-1 '><strong>10+</strong> </h3>
                        <p className='text-white '>Years of <br />Experience</p>
                    </div>
                    <div className='number ps-5'>
                        <h3 className=' fs-1'> <strong>200</strong> </h3>
